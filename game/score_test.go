...
func TestScoreSummary(t *testing.T) {
	...
	assert.Equal(t, true, redSummary.EnergizedRankingPoint)
	assert.Equal(t, false, redSummary.SuperChargedRankingPoint)
	assert.Equal(t, false, redSummary.TraversalRankingPoint)
	...
	assert.Equal(t, false, blueSummary.EnergizedRankingPoint)
	assert.Equal(t, false, blueSummary.SuperChargedRankingPoint)
	assert.Equal(t, true, blueSummary.TraversalRankingPoint)
...
func TestScoreAutoBonusRankingPoint(t *testing.T) {
	...
	redSummary := redScore.Summarize(blueScore)
	assert.Equal(t, false, redSummary.EnergizedRankingPoint)
...
func TestScoreCoralBonusRankingPoint(t *testing.T) {
	...
	assert.Equal(t, false, redScoreSummary.SuperChargedRankingPoint)
	...
	assert.Equal(t, 3, redScoreSummary.NumCoralLevelsGoal)
	assert.Equal(t, true, redScoreSummary.SuperChargedRankingPoint)
	...
	assert.Equal(t, false, blueScoreSummary.SuperChargedRankingPoint)
...
func TestScoreBargeBonusRankingPoint(t *testing.T) {
	...
	testCases := []struct {
		...
		// 1. All robots parked.
		{
			endgameStatuses:      [3]EndgameStatus{EndgameLevel1, EndgameLevel1, EndgameLevel1},
			fouls:                []Foul{},
			threshold:            14,
			expectedBonusAwarded: false,
		},
		...
		{
			endgameStatuses:      [3]EndgameStatus{EndgameLevel1, EndgameNone, EndgameLevel3},
			fouls:                []Foul{},
			threshold:            14,
		...
		{
			endgameStatuses:      [3]EndgameStatus{EndgameLevel3, EndgameLevel1, EndgameLevel1},
			fouls:                []Foul{},
			threshold:            16,
			expectedBonusAwarded: true,
		},
		...
		{
			endgameStatuses:      [3]EndgameStatus{EndgameLevel2, EndgameLevel3, EndgameLevel1},
			fouls:                []Foul{},
			threshold:            21,
			expectedBonusAwarded: false,
		},
		...
		// 6. All deep climbs.
		{
			endgameStatuses:      [3]EndgameStatus{EndgameLevel3, EndgameLevel3, EndgameLevel3},
			fouls:                []Foul{},
			threshold:            36,
			expectedBonusAwarded: true,
		},
	...
	for i, tc := range testCases {
		t.Run(
			...
			func(t *testing.T) {
				...
				assert.Equal(t, tc.expectedBonusAwarded, summary.TraversalRankingPoint)
			},
		)
	}
}
...
func TestScoreBargeBonusRankingPointIncludingAlgae(t *testing.T) {
	...
	summary = score.Summarize(&Score{})
	assert.Equal(t, true, summary.TraversalRankingPoint)
}
	...
	for i, tc := range testCases {
		t.Run(
			...
			func(t *testing.T) {
				...
				redSummary := redScore.Summarize(&blueScore)
				assert.Equal(t, tc.expectedCoralBonus, redSummary.SuperChargedRankingPoint)
				assert.Equal(t, tc.expectedBargeBonus, redSummary.TraversalRankingPoint)
...
func TestScoreEquals(t *testing.T) {
	...
	score2 = TestScore1()
	score2.EndgameStatuses[1] = EndgameLevel1
	assert.False(t, score1.Equals(score2))
	assert.False(t, score2.Equals(score1))
